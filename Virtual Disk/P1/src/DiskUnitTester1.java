...
public class DiskUnitTester1 {
	 ...
	 * @throws IOException 
	 */
	public static void main(String[] args) throws IOException, NonExistingDiskException {
		DiskUnit d = DiskUnit.mount("disk" + args[0]); // edit the name of the disk to mount
	...
	private static void showFileInDiskContent(DiskUnit d) throws IOException { 
	...
	private static void showDiskContent(DiskUnit d) throws IOException { 
