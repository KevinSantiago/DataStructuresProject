...
public class DiskUnitTester0 {
	 ...
	 */
	public static void main(String[] args) throws NonExistingDiskException, InvalidBlockNumberException, IOException {
	...
	private static void splitAndWriteToDisk(String s, DiskUnit d) throws InvalidBlockNumberException, IOException {
